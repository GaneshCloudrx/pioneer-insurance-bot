"""
Popup Handlers Module for Insurance Bot
...
def click_cancel_priority():
    ...
    try:
        ...
        priority_win = window.child_window(title="Priority", control_type="Window")
        if not priority_win.exists(timeout=config.TIMEOUT_POPUP_CHECK):
            return False
